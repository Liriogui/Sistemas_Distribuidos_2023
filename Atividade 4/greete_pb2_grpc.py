...
import greete_pb2 as greete__pb2
...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                ...
                request_serializer=greete__pb2.HelloRequest.SerializeToString,
                response_deserializer=greete__pb2.HelloReply.FromString,
                )
        ...
        self.ChattyClientSaysHello = channel.stream_unary(
                ...
                request_serializer=greete__pb2.HelloRequest.SerializeToString,
                response_deserializer=greete__pb2.DelayedReply.FromString,
                )
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHello': grpc.unary_unary_rpc_method_handler(
                    servicer.SayHello,
                    request_deserializer=greete__pb2.HelloRequest.FromString,
                    response_serializer=greete__pb2.HelloReply.SerializeToString,
            ),
            ...
            'ChattyClientSaysHello': grpc.stream_unary_rpc_method_handler(
                    ...
                    request_deserializer=greete__pb2.HelloRequest.FromString,
                    response_serializer=greete__pb2.DelayedReply.SerializeToString,
            ),
...
class Greeter(object):
    ...
    def SayHello(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/greet.Greeter/SayHello',
            greete__pb2.HelloRequest.SerializeToString,
            greete__pb2.HelloReply.FromString,
    ...
    def ChattyClientSaysHello(request_iterator,
        ...
        return grpc.experimental.stream_unary(request_iterator, target, '/greet.Greeter/ChattyClientSaysHello',
            greete__pb2.HelloRequest.SerializeToString,
            greete__pb2.DelayedReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
