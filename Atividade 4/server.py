...
class GreeterServicer(greete_pb2_grpc.GreeterServicer):
    def SayHello(self, request, context):
        print("SayHello Request Made:")
        print(request)
        hello_reply = greete_pb2.HelloReply()
    ...
    def ChattyClientSaysHello(self, request_iterator, context):
        delayed_reply = greete_pb2.DelayedReply()
...
def serve():
    ...
    greete_pb2_grpc.add_GreeterServicer_to_server(GreeterServicer(), server)
